...
# print(camera_frame_from_road_frame)
...
# print(extrinsic_matrix_eigen)
# print(ground_from_medmodel_frame)
...
def transform_img(base_img,
  ...
  # TEST
  # transmat = warp_matrix
  # print(transmat)
  # print(M)
  # augmented_rgb = cv2.warpPerspective(base_img, warp_matrix, output_size, borderMode=cv2.BORDER_REPLICATE)
  # TESTEND
